...
<ParamField path="cvarName" type="string" required>
...
<ParamField path="vector1" type="vector" required>
  The first vector (x, y, z)
</ParamField>

<ParamField path="vector2" type="vector" required>
  The second vector to add
</ParamField>

<ResponseField name="result" type="vector">
...
<ParamField path="scalar" type="float" required>
